    ...
    return (
        <div>
            <div className="container">
                <div className="d-flex justify-content-center align-items-center sena ">
                    <img src="/Img/LogoSena.png" alt="Logo Sena" className='logo-sena' />
                    <h1 className='title-sena'>Sena</h1>
                </div>
            </div>
            <div className='container'>
        ...
        <div className="container">
            <div className="card">
                ...
                <div className="card-body text-start">
                    ...
                    <p>
                        Desde nuestros inicios, siempre buscamos proporcionar <strong>instrucción técnica</strong> al empleado, <strong>formación complementaria</strong> para adultos, y ayudarles a los empleadores y trabajadores a <strong>establecer un sistema nacional de aprendizaje.</strong>
                    </p>
                    <p>
                        Nuestra Entidad que tiene una estructura conformada por <strong>trabajadores, empleadores y Gobierno</strong>, se llamó <strong>Servicio Nacional de Aprendizaje (SENA)</strong>, nombre que conserva en la actualidad. Desde ese entonces y hasta ahora, buscamos seguir conquistando nuevos mercados, suplimos a las empresas de mano calificada utilizando métodos modernos y continuamos trabajando para lograr un cambio de paradigma en cada uno de los procesos de la productividad.
                    </p>
                ...
                <div className="card-body text-start">
                    ...
                    <div className='container d-flex'>
                        <div className='col-6 d-flex justify-content-center align-items-center'>
                            <ol>
                                <li>El <a href="https://dle.rae.es/pi%C3%B1%C3%B3n">piñón</a>, representativo del sector industria.</li>
                        ...
                        <div className='col-6 d-flex justify-content-center align-items-center'>
                            <img src="/Img/EscudoSena.png" alt="Escudo Sena" />
                        </div>
                    </div>
                    <hr />
                    <h3>Logosímbolo</h3>
                    <div className='container d-flex'>
                        <div className='col-6 justify-content-center align-items-center'>
                            <p>El logosímbolo representa gráficamente los enfoques de la formación que impartimos en la que el individuo es el responsable de su propio proceso de aprendizaje. ​</p>
                        </div>
                        <div className='col-6 d-flex justify-content-center align-items-center'>
                    ...
                    <div className='container d-flex'>
                        <div className='col-6 justify-content-center align-items-center text-center'>
                            ...
                            <div className='text-center margin-top'>
                                <iframe width="440" height="250" src="https://www.youtube.com/embed/ZejiOSVZMyI" title="Himno del SENA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div className="col-6 justify-content-center align-items-center">
                            <div>
                            ...
                            <div className='margin-top'>
                                <h5 className='text-center'><strong>¿Quién creo el himno del Sena?</strong></h5>
                                <p>
                                    No hay mucho que contar sobre el <strong>autor del himno del Sena</strong>. Sólo podemos decir que la letra himno del sena la escribió Jesús Briceño y Luis Alfredo Sarmiento. En cuanto a la música, <strong>el himno del Sena completo</strong> es gracias a la composición de <strong>Daniel Marles Coro</strong>.
                                </p>
                                <p>
    ...
    return (
        <div className="container">
            <div className="card">
                ...
                <div className="card-body text-start">
                    <p>
                        Desde hace catorce años el Sena tiene un convenio con la institución educativa jaipera, el cual nos permite formarnos como  técnicos en sistemas desde el grado  décimo y once la cual desarrollamos  como un aprendiz del Sena  que se enfrentara a una sociedad tanto el  ámbito personal  como  profesional.
                    </p>
                </div>
            </div>
        </div>
